...
{
  new (message_memory) fleetmanager_interfaces::msg::Task(_init);
}

void Task_fini_function(void * message_memory)
{
  auto typed_message = static_cast<fleetmanager_interfaces::msg::Task *>(message_memory);
  typed_message->~Task();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Task_message_member_array[1] = {
  {
    ...
    offsetof(fleetmanager_interfaces::msg::Task, description),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Task_message_members = {
  ...
  "Task",  // message name
  1,  // number of fields
  sizeof(fleetmanager_interfaces::msg::Task),
...
{
  return &::fleetmanager_interfaces::msg::rosidl_typesupport_introspection_cpp::Task_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, fleetmanager_interfaces, msg, Task)() {
  return &::fleetmanager_interfaces::msg::rosidl_typesupport_introspection_cpp::Task_message_type_support_handle;
}
