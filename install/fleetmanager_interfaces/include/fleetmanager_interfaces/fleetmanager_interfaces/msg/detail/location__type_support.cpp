...
{
  new (message_memory) fleetmanager_interfaces::msg::Location(_init);
}

void Location_fini_function(void * message_memory)
{
  auto typed_message = static_cast<fleetmanager_interfaces::msg::Location *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Location_message_member_array[3] = {
  {
    ...
    offsetof(fleetmanager_interfaces::msg::Location, x),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(fleetmanager_interfaces::msg::Location, y),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(fleetmanager_interfaces::msg::Location, level),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Location_message_members = {
  ...
  3,  // number of fields
  sizeof(fleetmanager_interfaces::msg::Location),
...
get_message_type_support_handle<fleetmanager_interfaces::msg::Location>()
{
  return &::fleetmanager_interfaces::msg::rosidl_typesupport_introspection_cpp::Location_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, fleetmanager_interfaces, msg, Location)() {
  return &::fleetmanager_interfaces::msg::rosidl_typesupport_introspection_cpp::Location_message_type_support_handle;
}
