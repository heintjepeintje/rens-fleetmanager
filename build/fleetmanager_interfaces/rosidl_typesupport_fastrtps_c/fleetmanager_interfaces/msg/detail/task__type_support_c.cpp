...
#include "fleetmanager_interfaces/msg/detail/task__rosidl_typesupport_fastrtps_c.h"
...
using _Task__ros_msg_type = fleetmanager_interfaces__msg__Task;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = fleetmanager_interfaces__msg__Task;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const fleetmanager_interfaces__msg__Task * ros_message = static_cast<const fleetmanager_interfaces__msg__Task *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_fleetmanager_interfaces__msg__Task(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  fleetmanager_interfaces__msg__Task * ros_message = static_cast<fleetmanager_interfaces__msg__Task *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_fleetmanager_interfaces__msg__Task(cdr, ros_message);
}

static uint32_t _Task__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_fleetmanager_interfaces__msg__Task(
...
static size_t _Task__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_fleetmanager_interfaces__msg__Task(
