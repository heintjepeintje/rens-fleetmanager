...
#include "fleetmanager_interfaces/msg/detail/map_request__rosidl_typesupport_fastrtps_c.h"
...
using _MapRequest__ros_msg_type = fleetmanager_interfaces__msg__MapRequest;
...
{
  const _MapRequest__ros_msg_type * ros_message = static_cast<const _MapRequest__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = fleetmanager_interfaces__msg__MapRequest;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const fleetmanager_interfaces__msg__MapRequest * ros_message = static_cast<const fleetmanager_interfaces__msg__MapRequest *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_fleetmanager_interfaces__msg__MapRequest(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  fleetmanager_interfaces__msg__MapRequest * ros_message = static_cast<fleetmanager_interfaces__msg__MapRequest *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_fleetmanager_interfaces__msg__MapRequest(cdr, ros_message);
}

static uint32_t _MapRequest__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_fleetmanager_interfaces__msg__MapRequest(
...
static size_t _MapRequest__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_fleetmanager_interfaces__msg__MapRequest(
...
static message_type_support_callbacks_t __callbacks_MapRequest = {
...
static rosidl_message_type_support_t _MapRequest__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_MapRequest,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, fleetmanager_interfaces, msg, MapRequest)() {
  return &_MapRequest__type_support;
}
