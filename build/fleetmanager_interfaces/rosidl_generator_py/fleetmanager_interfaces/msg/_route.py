    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'fleetmanager_interfaces.msg.Route')
            logger.debug(
            ...
            from fleetmanager_interfaces.msg import Location
...
class Route(metaclass=Metaclass_Route):
    ...
    _fields_and_field_types = {
        'location': 'fleetmanager_interfaces/Location',
    }

    # This attribute is used to store an rosidl_parser.definition variable
    # related to the data type of each of the components the message.
    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['fleetmanager_interfaces', 'msg'], 'Location'),  # noqa: E501
    )
