...
class Metaclass_Status(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'fleetmanager_interfaces.msg.Status')
            logger.debug(
    ...
    def __prepare__(cls, name, bases, **kwargs):
        ...
        return {
            ...
            'STATUS_BUSY': cls.__constants['STATUS_BUSY'],
        }

    @property
    def STATUS_ERROR(self):
        """Message constant 'STATUS_ERROR'."""
        return Metaclass_Status.__constants['STATUS_ERROR']

    @property
    def STATUS_IDLE(self):
        """Message constant 'STATUS_IDLE'."""
        return Metaclass_Status.__constants['STATUS_IDLE']

    @property
    def STATUS_BUSY(self):
        """Message constant 'STATUS_BUSY'."""
        return Metaclass_Status.__constants['STATUS_BUSY']
