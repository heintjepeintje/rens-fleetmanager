...
static const _Location_type_support_symbol_names_t _Location_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, fleetmanager_interfaces, msg, Location)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, fleetmanager_interfaces, msg, Location)),
  }
};
...
{
  return &::fleetmanager_interfaces::msg::rosidl_typesupport_cpp::Location_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, fleetmanager_interfaces, msg, Location)() {
  return get_message_type_support_handle<fleetmanager_interfaces::msg::Location>();
}
