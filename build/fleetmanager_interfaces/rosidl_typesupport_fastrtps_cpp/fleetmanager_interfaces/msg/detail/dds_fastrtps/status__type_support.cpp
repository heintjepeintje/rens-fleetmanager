...
#include "fleetmanager_interfaces/msg/detail/status__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = fleetmanager_interfaces::msg::Status;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const fleetmanager_interfaces::msg::Status *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<fleetmanager_interfaces::msg::Status *>(
    untyped_ros_message);
...
{
  return &fleetmanager_interfaces::msg::typesupport_fastrtps_cpp::_Status__handle;
}
