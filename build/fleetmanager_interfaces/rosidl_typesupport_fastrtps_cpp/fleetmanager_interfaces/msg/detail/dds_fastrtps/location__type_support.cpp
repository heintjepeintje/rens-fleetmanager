...
#include "fleetmanager_interfaces/msg/detail/location__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const fleetmanager_interfaces::msg::Location & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  fleetmanager_interfaces::msg::Location & ros_message)
{
  // Member: x
  cdr >> ros_message.x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = fleetmanager_interfaces::msg::Location;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const fleetmanager_interfaces::msg::Location *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<fleetmanager_interfaces::msg::Location *>(
    untyped_ros_message);
...
{
  return &fleetmanager_interfaces::msg::typesupport_fastrtps_cpp::_Location__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, fleetmanager_interfaces, msg, Location)() {
  return &fleetmanager_interfaces::msg::typesupport_fastrtps_cpp::_Location__handle;
}
